  ...
  return (
    <div className='hero'>
      <div className="intro-text">
        ...
        <Link className='btn blue' to="/register"> Register Now! </Link>
        <Link className='btn red' to="/login"> Login </Link>
      </div>
      <div className=''>
        <img src="https://img.freepik.com/premium-vector/man-with-planner_118813-4924.jpg" alt="heroimage" width={"100%"} height={500} />
      </div>
    </div>
  )
}
